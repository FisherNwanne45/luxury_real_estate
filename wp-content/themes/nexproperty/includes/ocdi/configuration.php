...
function ocdi_after_import_setup($selected_import) {
	...
	set_theme_mod( 'footer_content', esc_html__('Discover your dream home with our tailored real estate solutions. From luxurious estates to cozy apartments, we make finding the perfect property effortless','nexproperty') );
