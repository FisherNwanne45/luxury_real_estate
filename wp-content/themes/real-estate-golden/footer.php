				...
				<div class="bottom-footer">
					<div class="row">
						...
						<div class="col-sm-6 text-sm-right">
							<h3><a href="//wpdirectorykit.com/themes/real-estate-golden.html" target="_blank"><?php echo esc_html__('Luxury Two Real Estate', 'real-estate-golden');?></a></h3>
						</div>
					</div>
