    ...
    <div class="wdk-body">
        <form method="post" action="" novalidate="novalidate">
            ...
            <div class="wdk-tabs-navs">
                ...
                <label for="wdk_tab_templates" <?php if(wmvc_show_data('wdk_tabs',$_POST) == 'wdk_tab_templates'):?> class="active" <?php endif;?>><?php echo esc_html__('Templates','wpdirectorykit');?></label>
