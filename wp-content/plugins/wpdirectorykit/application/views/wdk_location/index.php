        ...
        <table class="wp-list-table widefat fixed striped table-view-list pages">
            ...
            <?php foreach ( $locations as $location ):?>
                <tr>
                    ...
                    <td>
                        <?php echo str_pad('', wmvc_show_data('level', $location, 0)*12, '&nbsp;').'|-'; ?><a href="<?php echo esc_url(get_admin_url() . "admin.php?page=wdk_location&function=edit&id=".wmvc_show_data('idlocation', $location, '-')); ?>"><?php echo wmvc_show_data('location_title', $location, '-').' #'.wmvc_show_data('idlocation', $location, '-'); ?></a>
                    </td>
                    <td>
                    ...
                    <td class="actions_column">
                        <a href="<?php echo esc_url(get_admin_url() . "admin.php?page=wdk_location&function=edit&id=".wmvc_show_data('idlocation', $location, '-')); ?>" title="<?php echo esc_attr__('Edit','wpdirectorykit');?>"><span class="dashicons dashicons-edit"></span></a>
                        <a class="question_sure" href="<?php echo esc_url(get_admin_url() . "admin.php?page=wdk_location&function=delete&id=".wmvc_show_data('idlocation', $location, '-')."&_wpnonce=".wp_create_nonce( 'wdk-location-delete_'.wmvc_show_data('idlocation', $location, '-')));?>" title="<?php echo esc_attr__('Remove','wpdirectorykit');?>"><span class="dashicons dashicons-no"></span></a>
                    </td>
                </tr>
            <?php endforeach; ?>
