                                    ...
                                    <?php if($field->field_type == "SECTION"):?>
                                        <div class="wdk-col-md-12 wdk-col-section">
                                            <div class="wdk_field section">
                                                <?php echo esc_html(wmvc_show_data('field_label', $field));?>:
                                                <label for="">
                                                    <input name="field_depend_<?php echo esc_attr(wmvc_show_data('idfield', $field));?>" type="checkbox" id="field_all_depend_<?php echo esc_attr(wmvc_show_data('idfield', $field));?>" value="1" class="regular-text trigger_section">
                                                </label>
                                            </div>
                                        </div>
                                    <?php else: ?>
                                        <div class="wdk-col-md-<?php echo esc_attr($field->columns_number); ?> ">
                                            <div class="wdk_field">
                                                <label for="field_hide_<?php echo esc_attr(wmvc_show_data('idfield', $field));?>"><?php echo esc_html(wmvc_show_data('field_label', $field));?></label>
