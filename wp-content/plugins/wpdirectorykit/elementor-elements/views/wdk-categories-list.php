    ...
    <div class="wdk-categories-list">
        <ul class="wdk-categories">
            <?php if(count($results) > 0):?>
                ...
                <li class="wdk-item">
                    <a href="<?php echo esc_url(wdk_url_suffix($results_page,'search_category='.wmvc_show_data('idcategory', $value)));?><?php echo (wmvc_show_data('conf_query_params', $this->data['settings'], false)) ? '&'.wmvc_show_data('conf_query_params', $this->data['settings']):''; ?>#results"  class="wdk-link">
                        ...
                        <?php endif;?>
                        <span class="wdk-title"><?php echo wmvc_show_data('prefix', $settings, '').wmvc_show_data('category_title', $value).wmvc_show_data('suffix', $settings, '');?></span>
